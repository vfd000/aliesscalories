...
# If modifying these scopes, delete the file creds/token.json.
SCOPES = ["https://www.googleapis.com/auth/spreadsheets.readonly"]

# The ID and range of a sample spreadsheet.
SAMPLE_SPREADSHEET_ID = "1BeUc1WCAZxllLYw1tOiFwrVKY8o3JWNbd7kyLt9SdUQ"
...
def main():
    ...
    """
    creds = None
    # The file creds/token.json stores the user's access and refresh tokens, and is
    ...
    try:
        ...
        # Create a word cloud from the data
        create_word_cloud(values)
